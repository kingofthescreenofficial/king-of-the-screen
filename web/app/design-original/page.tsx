      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="relative mx-auto my-4 w-full max-w-5xl overflow-hidden rounded-2xl border-2 border-yellow-500/50 bg-gradient-to-b from-[#141422] to-[#0d0d15] p-5 shadow-2xl sm:p-7">
          ...
          <div className="relative mx-auto mb-6 max-w-3xl space-y-3 text-center">
            <span className="inline-flex items-center gap-2 rounded-full border border-yellow-500/30 bg-yellow-500/10 px-3.5 py-1.5 text-xs font-bold tracking-wider text-yellow-400"><Gem className="h-4 w-4" /> PUBLIC SCREEN ARCHIVE</span>
            <h2 className="text-2xl font-black leading-tight tracking-tight sm:text-4xl">ONE SCREEN. <span className="text-yellow-400">100 ARCHIVAL CROWN RECORDS.</span></h2>
            <p className="mx-auto max-w-2xl text-xs leading-relaxed text-gray-300 sm:text-base">King of the Screen is a public art and status experiment. <strong className="text-emerald-400">The first season is in pre-launch. Payments, token activity, and NFT activity are disabled.</strong></p>
          </div>
          <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-3">
            {steps.map((step) => (
              <article key={step.number} className="space-y-2 rounded-xl border border-cyber-border/80 bg-black/60 p-4">
                ...
                <p className="text-xs leading-relaxed text-gray-400">The public record is prepared. This action stays unavailable before launch.</p>
              </article>
            ))}
          </div>
        ...
        <section className="relative mx-auto my-4 w-full max-w-5xl overflow-hidden rounded-2xl border-2 border-yellow-500/80 bg-cyber-card shadow-[0_0_50px_rgba(234,179,8,0.35)]">
          ...
          <div className="space-y-5 border-t-2 border-yellow-500/40 bg-[#11111c] p-5 sm:p-8">
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-cyber-border/60 pb-3">
              <div className="flex items-center gap-3"><span className="text-glow-gold flex items-center gap-2 text-2xl font-black tracking-wide sm:text-4xl">👑 CROWN RECORD #001</span><span className="rounded-md bg-gradient-to-r from-yellow-400 to-amber-500 px-3 py-1 text-xs font-black uppercase tracking-wider text-black">UNASSIGNED</span></div>
            ...
            <p className="text-2xl font-black leading-tight tracking-tight text-emerald-300 sm:text-4xl">"A public record will appear here after launch."</p>
