      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="relative mx-auto my-4 w-full max-w-5xl overflow-hidden rounded-2xl border-2 border-yellow-500/50 bg-gradient-to-b from-[#141422] to-[#0d0d15] p-5 shadow-2xl sm:p-7">
          ...
          <div className="relative mx-auto mb-6 max-w-3xl space-y-3 text-center">
            <span className="inline-flex items-center gap-2 rounded-full border border-yellow-500/30 bg-yellow-500/10 px-3.5 py-1.5 text-xs font-bold tracking-wider text-yellow-400"><Gem className="h-4 w-4" /> GAMEFI &amp; SOCIAL BILLBOARD 2.0</span>
            <h2 className="text-2xl font-black leading-tight tracking-tight sm:text-4xl">THE $1M THRONE: RULE THE SCREEN &amp; CLAIM YOUR <span className="text-yellow-400">1-OF-100 NFT</span></h2>
            <p className="mx-auto max-w-2xl text-xs leading-relaxed text-gray-300 sm:text-base">One global screen. A public space for image, message, and link. <strong className="text-emerald-400">This is a visual archive preview. Payments, token activity, and NFT activity stay disabled.</strong></p>
          </div>
          <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-3">
            {steps.map((step) => (
              <article key={step.number} className="space-y-2 rounded-xl border border-cyber-border/80 bg-black/60 p-4">
                ...
                <p className="text-xs leading-relaxed text-gray-400">Archived interface layout. No transaction or wallet connection is available.</p>
              </article>
            ))}
          </div>
        ...
        <section className="relative mx-auto my-4 w-full max-w-5xl overflow-hidden rounded-2xl border-2 border-yellow-500/80 bg-cyber-card shadow-[0_0_50px_rgba(234,179,8,0.35)]">
          <div className="flex min-h-[320px] items-center justify-center bg-black p-8 text-center sm:min-h-[460px]">
            <div><Crown className="mx-auto mb-4 h-20 w-20 text-yellow-400/50" /><p className="text-xl text-gray-400">The throne awaits its next conqueror.</p></div>
          </div>
          <div className="space-y-5 border-t-2 border-yellow-500/40 bg-[#11111c] p-5 sm:p-8">
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-cyber-border/60 pb-3">
              <div className="flex items-center gap-3"><span className="text-glow-gold flex items-center gap-2 text-2xl font-black tracking-wide sm:text-4xl">👑 THE FIRST KING</span><span className="rounded-md bg-gradient-to-r from-yellow-400 to-amber-500 px-3 py-1 text-xs font-black uppercase tracking-wider text-black">Active Monarch #1</span></div>
              <span className="flex items-center gap-1.5 rounded-xl border border-yellow-500/60 bg-gradient-to-r from-purple-900/60 to-yellow-900/60 px-3.5 py-1.5 text-xs font-black text-yellow-300"><Gem className="h-4 w-4 text-purple-400" /> VIEW 1-OF-100 NFT RELIC</span>
            </div>
            <p className="text-2xl font-black leading-tight tracking-tight text-emerald-300 sm:text-4xl">"The screen is waiting for its story."</p>
        ...
        <section className="relative mx-auto my-6 w-full max-w-5xl overflow-hidden rounded-2xl border border-cyber-border bg-cyber-card p-4 shadow-xl sm:p-6">
          <div className="mb-4 flex flex-col justify-between gap-4 sm:flex-row sm:items-center"><div><span className="flex items-center gap-2 text-xs tracking-widest text-emerald-400"><Target className="h-4 w-4" /> GLOBAL MONUMENT PROGRESS</span><div className="mt-1 flex items-baseline gap-2"><span className="text-glow-green text-3xl font-black sm:text-4xl">$0.00</span><span className="text-sm text-gray-400">/ $1,000,000.00</span></div></div><span className="rounded-xl border border-cyber-border bg-black/50 px-3 py-2 text-xs text-gray-400">0 DETHRONEMENTS</span></div>
