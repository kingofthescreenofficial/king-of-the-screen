...
export async function POST(request: Request) {
  ...
  try {
    const body = await request.json() as { walletAddress?: unknown; displayName?: unknown; message?: unknown };
    if (typeof body.walletAddress !== "string" || typeof body.displayName !== "string" || typeof body.message !== "string") throw new Error("INVALID_NFT_PREVIEW");
