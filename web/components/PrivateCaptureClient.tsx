  ...
  async function capture() {
    ...
    try {
      ...
      for (let attempt = 0; attempt < 8; attempt += 1) {
        ...
        const response = await fetch("/api/private-capture/settle", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ intentId: preview.id, signature: result.signature }) });
      ...
      setStatus("Transfer sent. Solana finalization is still pending. Press settle again after a few seconds.");
