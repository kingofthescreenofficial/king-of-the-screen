...
Связанное исследование США: `docs/US_CRYPTO_LAUNCH_RISK_RESEARCH_2026-09-05.md`.
...
- `CONTENT_SUBMISSIONS_ENABLED` остаётся выключенным.
- `PUBLIC_CROWN_ARCHIVE_ENABLED` остаётся выключенным.
